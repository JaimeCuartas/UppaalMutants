...
public class MutantController {
    ...
    public MutantController(String modelFile, File fileMutants) throws IOException {
    ...
    public void tmiOperator(){
        this.prepareTmiOperator();
    }

    public void tadOperator(){
        this.prepareTadOperator();
    }
    public void tadSyncOperator(String chanSync){
        this.prepareTadSyncOperator(chanSync);
    }
    public void tadRandomSyncOperator(){
        this.prepareTadRandomSyncOperator();
    }
    public void smiOperator(){
        this.prepareSmiOperator();
    }
    public void smiNoRedundantOperator(){
        this.prepareSmiNoRedundantOperator();
    }
    public void cxlOperator(){
        this.prepareCxlOperator();
    }
    public void cxsOperator(){
        this.prepareCxsOperator();
    }
    public void ccnOperator(){
        this.prepareCcnOperator();
    }
